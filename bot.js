...
const developers = ["521350578727813151","448590558160748545"]//Toxic Codes
...
=========================================================
Support server : https://discord.gg/4xHs38J
`)
...
client.on('message', message => {
  ...
  if(message.channel.id !== '529786283967512578') return;
  if (message.author.bot) return;
